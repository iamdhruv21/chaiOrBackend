...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, channelName[0], "User Channel fetched Successfully"))
})
...
// to test refreshAccessToken, updateUserAvatar, updateUserCoverImage